...
class PhenotypeConfig:
    model_id: str = "synthetic_height_like"
    model_version: str = "1.0.0"
    disclosure: str = "Explicit synthetic phenotype model; not a biological or clinical predictor."
...
class PhenotypeEngine:
    ...
    def evaluate_diploid(
        ...
        for pair in self.config.epistasis:
            formula_parts.append(f"{pair.coefficient}*({pair.locus_a}×{pair.locus_b})")
        if noise_val != 0:
