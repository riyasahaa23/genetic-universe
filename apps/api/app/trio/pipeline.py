...
from .evidence_inputs import attach_phase, attach_reference_knowledge, phenotype_observations, verified_artifacts, PHASE_FILTERS
...
class FamilyStore:
    ...
    def families(self) -> list[Family]:
        result = []
        for path in sorted((self.root / "metadata").glob("*.family.json")):
